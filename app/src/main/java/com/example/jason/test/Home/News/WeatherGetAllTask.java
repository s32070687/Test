...
public class WeatherGetAllTask extends AsyncTask<Object, Integer, List<Weather>> {

    //OKHttp
    private OkHttpClient client = new OkHttpClient();

    //Log專用
    private final static String TAG = "WeatherGetAllTask";
    ...
    @Override
    protected List<Weather> doInBackground(Object... objects) {
        String jsonIn;
